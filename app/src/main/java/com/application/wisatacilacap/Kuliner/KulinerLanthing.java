...
public class KulinerLanthing extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuliner_lanthing);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(KulinerLanthing.this, MapsKulinerLanthing.class);
                startActivity(i);
            }
        });
        ...
        callIntent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(KulinerLanthing.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng sydney1 = new LatLng(-7.7052736,109.0219122);
        mMap.addMarker(new MarkerOptions().position(sydney1).title("Cita Rasa Mandiri"));
