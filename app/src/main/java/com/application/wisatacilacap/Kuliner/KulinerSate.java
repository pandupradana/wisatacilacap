...
public class KulinerSate extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kuliner_sate);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(KulinerSate.this, MapsKulinerSate.class);
                startActivity(i);
            }
        });
        ...
        callIntent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ActivityCompat.checkSelfPermission(KulinerSate.this, Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
