...
public class BentengPendem extends AppCompatActivity implements OnMapReadyCallback {
    ...
    int[] images = {R.drawable.benteng_pendem, R.drawable.bentengpendem2, R.drawable.bentengpendem3, R.drawable.bentengpendem4};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(BentengPendem.this, MapsBentengPendem.class);
                startActivity(i);
            }
        });
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(sydney).title("Benteng Pendem"));
